...
void SetCurrentContext(RuntimeContext& context) { current_context = &context; }

void ClearCurrentContext() { current_context = 0; }

bool HasCurrentContext() { return current_context != 0; }
...
RuntimeContextScope::~RuntimeContextScope() { current_context = previous_; }
} // namespace lpmd
