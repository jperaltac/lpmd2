...
void SuttonChen::ShowHelp() const {
  ...
  std::cout
      << "                      considered (true / false). Recommended for homogeneous systems.\n";
  std::cout << "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n";
  std::cout << " Example          >>                                                           \n";
...
Vector SuttonChen::ManyBodies(const Vector& normrij, const double& rhoi, const double& rhoj,
                              const double& rmod) const {
  double ir = 1.0e0 / rmod;
