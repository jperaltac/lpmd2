...
double FinnisSinclair::F(const double& rhoi) const { return -A * sqrt(rhoi); }
...
Vector FinnisSinclair::ManyBodies(const Vector& normrij, const double& rhoi, const double& rhoj,
...
Vector FinnisSinclair::UpdateCorrections(const double& rho, const int& N,
